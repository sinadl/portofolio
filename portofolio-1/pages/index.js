      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            <h2 className='text-5xl py-2 text-teal-500 font-medium md:text-6xl'>Sina Farahani</h2>
          ...
          <div className='overflow-hidden relative bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 mx-auto md:h-96 md:w-96'>
            <Image src={daved} alt='me' layout='fill' objectFit='cover' />
          </div>
        </section>
        <section>
          <div>
            <h3 className='text-3xl pt-3 pb-1 dark:text-white'>Services I Offer</h3>
            <p className='text-md py-1 leading-8 text-gray-600 dark:text-gray-400'>
              since the beginning of my journy as freelance developer, i've done some remote work for
              <span className='text-teal-500'> agancies</span>, consulted for 
              <span className='text-teal-500'> startups</span> and colaborated with talented people to create products for both
              business and consumer use.
            </p>
            <p className='text-md py-3 leading-8 text-gray-600 dark:text-gray-400'>
              I offer from a wide range of services, including brand design, programming and teaching.
            </p>
          </div>
          <div className='lg:flex gap-10'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:text-gray-400'>
              <Image className='mx-auto' alt='Design' src={design} width={100} height={100}/>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              <Image className='mx-auto' alt='Code' src={code} width={100} height={100}/>
              <h3 className='text-lg font-medium pt-8 pb-2 dark:text-white'>Beautiful Design</h3>
              <p className='py-2 dark:text-gray-400'>
                Creating elegant designs suited for your needs following core design theory
              </p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10'>
              <Image className='mx-auto' alt='consulting' src={consulting} width={100} height={100}/>
              <h3 className='text-lg font-medium pt-8 pb-2 dark:text-white'>Beautiful Design</h3>
              <p className='py-2 dark:text-gray-400'>
                Creating elegant designs suited for your needs following core design theory
              </p>
